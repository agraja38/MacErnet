...
- Can turn Wi-Fi off while Ethernet is connected and restore it when Ethernet disconnects.
...
1. Download `MacErnet-1.0.4-universal.dmg` from the latest release.
